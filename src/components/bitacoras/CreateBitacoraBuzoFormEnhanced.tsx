...
// Esquema de validación completo para Bitácora Buzo
...
interface BitacoraBuzoFormData {
  folio: string;
...
interface CreateBitacoraBuzoFormEnhancedProps {
  ...
  onCancel: () => void;
  bitacoraSupervisor?: any; // Datos de la bitácora supervisor para pre-llenar
}

export const CreateBitacoraBuzoFormEnhanced = ({ 
  onSubmit, 
  onCancel, 
  bitacoraSupervisor 
}: CreateBitacoraBuzoFormEnhancedProps) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      // Pre-llenar con datos de bitácora supervisor si existe
      ...(bitacoraSupervisor && {
        empresa_nombre: bitacoraSupervisor.contratista_nombre || "",
        supervisor_nombre: bitacoraSupervisor.supervisor_nombre_matricula || "",
        buzo_nombre: bitacoraSupervisor.buzo_principal_datos?.nombres || "",
      })
    }
  });
          ...
          <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-8">
            ...
            <div className="bg-green-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Input id="buzo_nombre" {...register('buzo_nombre')} />
            ...
            <div className="bg-purple-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                  ...
                  <Input id="supervisor_nombre" {...register('supervisor_nombre')} />
            ...
            <div className="bg-orange-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <Input id="tiempos_intervalo_superficie" {...register('tiempos_intervalo_superficie')} placeholder="Opcional" />
                </div>
                <div>
                  <Label htmlFor="tiempos_nitrogeno_residual">Nitrógeno residual</Label>
                  <Input id="tiempos_nitrogeno_residual" {...register('tiempos_nitrogeno_residual')} placeholder="Opcional" />
                </div>
                <div>
                  <Label htmlFor="tiempos_grupo_repetitivo_anterior">Grupo repetitivo anterior</Label>
                  <Input id="tiempos_grupo_repetitivo_anterior" {...register('tiempos_grupo_repetitivo_anterior')} placeholder="Opcional" />
                </div>
                <div>
                  <Label htmlFor="tiempos_nuevo_grupo_repetitivo">Nuevo grupo repetitivo</Label>
                  <Input id="tiempos_nuevo_grupo_repetitivo" {...register('tiempos_nuevo_grupo_repetitivo')} placeholder="Opcional" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-emerald-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <Input id="objetivo_tipo_area" {...register('objetivo_tipo_area')} placeholder="ej: Jaulas de cultivo" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Textarea id="objetivo_proposito" {...register('objetivo_proposito')} 
                    placeholder="Describa detalladamente el propósito del buceo..." className="min-h-[100px]" />
                ...
                <div>
                  ...
                  <Textarea id="objetivo_caracteristicas_dimensiones" {...register('objetivo_caracteristicas_dimensiones')} 
                    placeholder="Describa las características y dimensiones del área de trabajo..." className="min-h-[100px]" />
            ...
            <div className="bg-red-50 p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="flex items-center space-x-2">
                  <Checkbox 
                    ...
                    {...register('condcert_buceo_altitud')}
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox 
                    ...
                    {...register('condcert_certificados_equipos_usados')}
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox 
                    ...
                    {...register('condcert_buceo_areas_confinadas')}
              ...
              <div className="mt-4">
                ...
                <Textarea id="condcert_observaciones" {...register('condcert_observaciones')} 
                  placeholder="Observaciones adicionales..." className="min-h-[80px]" />
              </div>
            </div>
            ...
            <div className="flex justify-end gap-4 pt-6 border-t">
              ...
              <Button type="submit" disabled={loading} className="min-w-[120px] bg-teal-600 hover:bg-teal-700">
                {loading ? (
                  <>
