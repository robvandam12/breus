    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="mt-2 text-gray-600">
          Datos básicos de la operación de buceo y condiciones de trabajo
        </p>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Sitio donde se realizará la faena"
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Nombre y matrícula del supervisor"
                className="bg-blue-50"
                readOnly
              />
            </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-800">
            <strong>Información:</strong> Los campos de lugar y supervisor se auto-poblarán desde la operación seleccionada.
            Complete los datos de condiciones de trabajo para continuar.
          </div>
        </div>
      </div>
    </div>
