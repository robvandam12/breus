      ...
      <CardContent className="space-y-4">
        <div className="flex items-center gap-4">
          <div className="flex-1">
            <Select value={selectedOperacionId} onValueChange={onSelectOperacion}>
              <SelectTrigger>
                <SelectValue placeholder="Seleccione una operación para crear HPT..." />
              </SelectTrigger>
              <SelectContent>
        ...
        {operacionesDisponibles.length === 0 && (
          <div className="text-center py-6 text-gray-500">
            ...
            <p>No hay operaciones disponibles para crear HPT</p>
            <p className="text-sm">Todas las operaciones ya tienen HPT asociado</p>
          </div>
        )}
      </CardContent>
    </Card>
