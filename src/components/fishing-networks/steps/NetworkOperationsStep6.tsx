...
interface NetworkOperationsStep6Props {
  formData: NetworkOperationsData;
  updateFormData: (updates: Partial<NetworkOperationsData>) => void;
  readOnly?: boolean;
}

export const NetworkOperationsStep6 = ({ 
  formData, 
  updateFormData, 
  readOnly = false 
}: NetworkOperationsStep6Props) => {
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-gray-600 mb-6">
            Para completar el formulario de faenas de redes, se requieren las firmas 
