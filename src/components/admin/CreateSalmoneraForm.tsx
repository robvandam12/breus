...
export interface CreateSalmoneraFormProps {
  onSubmit: (data: any) => Promise<void>;
  onCancel: () => void;
}

export const CreateSalmoneraForm = ({ onSubmit, onCancel }: CreateSalmoneraFormProps) => {
      ...
      <CardContent className="p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-3 pt-6 border-t border-gray-200">
            ...
            >
              {isSubmitting ? 'Creando...' : 'Crear Salmonera'}
            </Button>
            <Button
              type="button"
              variant="outline"
